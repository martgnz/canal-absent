...
L.marker([41.397207, 2.035329], {icon: marker5})
    .bindPopup("<h3>Pont de Can Sant Feliu del Camí</h3><br /><iframe width='465' height='290' src='https://www.youtube.com/embed/Vu5qW7h9gYA' frameborder='0' allowfullscreen></iframe><p>Aquest és un dels pocs trams que es conserven tal i com devien ser en un principi. Esther Hachuel, arqueòloga del Centre d’Estudis Comarcals del Baix Llobregat, ens l’ensenya.</p>").addTo(map);

L.marker([41.374994, 2.051414], {icon: marker6})
    .bindPopup("<h3>Salt de l’Erasme</h3><br /><img src='img/salt-erasme.jpg'><p>A partir d’aquest punt l’aigua del canal es desvia cap a sèquies menors fins a Can Trabal, a l’Hospitalet.</p>").addTo(map);
...
L.marker([41.361226, 2.090673], {icon: marker8})
    .bindPopup("<h3>Rambla Solanes / Hospitalet</h3><br /><img src='img/rambla-solanes.jpg'><p>Fins fa ben poc la Remunta tenia un aspecte similar al d’aquesta zona, que es troba a molt pocs metres però en terme municipal de Cornellà, sense interès a urbanitzar la zona.</p>").addTo(map);
