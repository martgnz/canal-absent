...
L.marker([41.374994, 2.051414], {icon: marker6})
    .bindPopup("<h3>Salt de l'Erasme / Sant Joan Despí</h3><br /><div class='row'><div class='col-md-6'><img class='img-fluid' src='img/salt-erasme.jpg'></div><div class='col-md-6'><p>A partir d’aquest punt l’aigua del canal es desvia cap a sèquies menors fins a Can Trabal, a l’Hospitalet. Foto: Esther Hachuel</p></div></div>").addTo(map);
