...
L.marker([41.352521887365626, 2.1521511626534315], {icon: marker8})
    .bindPopup("<strong>Pont Cornellà / Hospitalet</strong><br />A pocs metres del pont de la Remunta hi ha un tros de canal que sí que s’ha preservat. L’ajuntament de Cornellà no vol construir en aquesta zona a diferència del de l’Hospitalet.").addTo(map);
...
L.marker([41.353161, 2.155336], {icon: marker11})
    .bindPopup("<strong>Cementiri de Montjuïc / Barcelona</strong><br />L’últim punt on es conserva el canal, per estar adossat al mur del cementiri de Montjuïc.").addTo(map);
